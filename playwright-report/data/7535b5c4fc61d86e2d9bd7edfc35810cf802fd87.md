...
- Name: e2e/ask-arun.spec.ts >> Ask Arun sends messages and clears history
- Location: tests/e2e/ask-arun.spec.ts:30:5
...
Call log:
  - waiting for getByRole('button', { name: /start a new chat/i })
    - locator resolved to <button type="button" title="New chat" class="ask-arun-icon-btn" aria-label="Start a new chat">…</button>
...
- generic [ref=e1]:
    ...
    - generic [ref=e22]:
      - generic [ref=e23]:
        - generic [ref=e24]:
          ...
          - generic [ref=e28]: Cybersecurity L|
  ...
  - dialog [ref=e411]:
    ...
    - log "Conversation" [ref=e426]:
      ...
      - paragraph [ref=e436]: Who is Arun?
      - paragraph [ref=e442]: Arun Kumar is a BCA student and Cybersecurity Enthusiast based in India.
    - generic [ref=e444]:
      - textbox "Type your message" [active] [ref=e445]:
